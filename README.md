...
> [!NOTE]
> Verify that a Nerd Font is installed to ensure proper icon rendering. The configuration here uses [**JetBrainsMono Nerd Font**](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/JetBrainsMono.zip); if a different Nerd Font is used, update the font settings in styles.css for YASB accordingly.
